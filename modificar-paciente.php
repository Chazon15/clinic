...
<section class="content home">
	...
	if ($_POST["idPaciente"] != ""){
		...
		$comonosconocio=$_POST['comonosconocio'];
		...
		$sql = "UPDATE pacientes SET fechanacimiento='".$ano."-".$mes."-".$dia."', Nombres='".$Nombres."',Apellidos='".$Apellidos."',direccion='".$direccion."',telefono='".$telefono."',alergias='".$alergias."',comonosconocio='".$comonosconocio."',motivoconsulta='".$motivoconsulta."' WHERE idPaciente=".$idPaciente."";

			$resultado=mysqli_query($mysqli,$sql) or die ('Error en el query database');
			
		
		
		echo "<a href='pacientes.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    echo"<div class='icon'> <i class='zmdi zmdi-check-square col-green'></i> </div>";
                    echo"<div class='content'>";
                        echo"<div class='text'>Paciente actualizado correctamente!</div>";
                        echo"<div class='number'> Se modificó, todo Ok </div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
		
		echo "<a href='agregar-paciente.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    echo"<div class='icon'> <i class='zmdi zmdi-accounts-add col-blue'></i> </div>";
                    echo"<div class='content'>";
                        echo"<div class='text'>Clínica Odontológica Iberico</div>";
                        echo"<div class='number'> Añadir otro paciente  </div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
		...
		echo "<div class='alert alert-warning' role='alert'>";
		  echo "No se pudo modificar al paciente !! <br />  Intenta añadirlo nuevamente <a href='pacientes.php'> >>click aqui<< </a> <br /><br /> Si persiste el problema llamar a Julio Ernesto";
		echo "</div>";
		echo "<br />";
	}
