...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>AGREGAR UN DOCTOR</h2>
            <big class="text-muted">¿Cómo agregar un doctor?</big> <br />
			<small>
				<ul>
				<li>Completar todos los datos correctamente</li>
				<li>Hacerlo cuidadosamente</li>
				<li>No se puede borrar ningún doctor</li>
...
<!-- PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP-->
	...
	<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
					<div class="header">
						<h2>AÑADIR DOCTOR: <small>Llenar bien los datos. <small> </h2>						
					</div>
					<form action="agregado-doctor.php" method="post" id="f1" name="formulario" class="formulario" enctype="multipart/form-data">
					<div class="body">
                        <div class="row clearfix">
                        ...
                        <div class="row clearfix">                            
							...
							<div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea name="ciudad" id="ciudad" rows="4" class="form-control no-resize" placeholder="Ciudad"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <button onclick="agregar()" type="submit" name="submit" class="btn btn-raised g-bg-cyan">Añadir</button>
								<button type="reset"  class="btn btn-raised g-bg-red">Cancelar</button>
                            </div>
						</form>	
                        </div>
                    </div>
