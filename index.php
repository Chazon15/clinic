...
while( $fila = $resultado->fetch_assoc()){
	$cont++;
	$numPacientesTotales=$cont;	
}
while( $fila2 = $resultado2->fetch_assoc()){	
	
	$haber=$fila2['Haber']+$haber;
	$debe=$fila2['Debe']+$debe;
	if ( substr($fila2['fecha'],5,-3) == $mes){
		$numPacientesMes++;
		$haberMes=$fila2['Haber']+$haberMes;
		$debeMes=$fila2['Debe']+$debeMes;
	}
	if ( $fila2['fecha'] == $fechaCompleta){
		$numPacientesHoy++;
		$haberHoy=$fila2['Haber']+$haberHoy;
		$debeHoy=$fila2['Debe']+$debeHoy;
	}	
}
    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number"><?php echo $numPacientesHoy;?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">Pacientes-ÚLTIMO MES</div>
                        <div class="number"><?php echo $numPacientesMes;?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">Ingresos del mes</div>
                        <div class="number"><?php echo $haberMes;?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number"><?php echo $haberHoy;?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2 class="font-weight-bold">PACIENTES<small >Comparativa  gráfica</small></h2>
                        
                    </div>
                    <div class="body">
                        <div class="stats-report">
                          <div class="stat-item">
                            <h5 class="font-weight-bold text-primary">Desde siempre</h5>
                            <div class="col-indigo text-center font-weight-bold" ><?php echo $numPacientesTotales; ?></div>
						  </div>
                          <div class="stat-item">
                            <h5 class="font-weight-bold text-primary">Este mes</h5>
                            <div class="col-indigo text-center font-weight-bold"><?php echo $numPacientesMes;?></div></div>
                          <div class="stat-item">
                            <h5 class="font-weight-bold text-primary">Hoy</h5>
                            <div class="col-indigo text-center font-weight-bold"><?php echo $numPacientesHoy;?></div></div>
                        </div>
                        <div class="sparkline" data-type="line" data-spot-Radius="3" data-highlight-Spot-Color="rgb(63, 81, 181)" data-highlight-Line-Color="#822"
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2>Ingresos <small>Comparativa gráfica</small></h2>
                    ...
                    <div class="body">
                        <div class="stats-report">
                          <div class="stat-item">
                            <h5>Desde siempre</h5>
                            <b class="col-blue-grey"><?php echo $haber;?></b></div>
                          <div class="stat-item">
                            <h5>Este mes</h5>
                            <b class="col-blue-grey"><?php echo $haberMes;?></b></div>
                          <div class="stat-item">
                            <h5>Hoy</h5>
                            <b class="col-blue-grey"><?php echo $haberHoy;?></b></div>
                        </div>
                        <div class="sparkline" data-type="line" data-spot-Radius="3" data-highlight-Spot-Color="rgb(233, 30, 99)" data-highlight-Line-Color="#222"
                                 data-min-Spot-Color="rgb(233, 30, 99)" data-max-Spot-Color="rgba(233, 30, 99, 0.9)" data-spot-Color="rgba(233, 30, 99, 0)"
                                 data-offset="90" data-width="100%" data-height="100px" data-line-Width="1" data-line-Color="rgba(233, 30, 99, 0.75)"
                                 data-fill-Color="rgba(233, 30, 99, 0.3)"> 6,4,7,8,4,3,2,2,5,6,7,4,1,5,7,9,9,8,7,6 </div>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="header">
                        <h2>INGRESOS PENDIENTES<small>Dinero falto de pago</small></h2>                        
                    </div>
                    <div class="body">
                        <div class="stats-report">
                          <div class="stat-item">
                            <h5>Desde siempre</h5>
                            <b class="col-green"><?php echo $debe;?></b></div>
                          <div class="stat-item">
                            <h5>Este mes</h5>
                            <b class="col-green"><?php echo $debeMes;?></b></div>
                          <div class="stat-item">
                            <h5>Hoy</h5>
                            <b class="col-green"><?php echo $debeHoy;?></b></div>
                        </div>
                        <div class="sparkline" data-type="line" data-spot-Radius="3" data-highlight-Spot-Color="rgba(0, 188, 212, 0.9)" data-highlight-Line-Color="#222"
                                 data-min-Spot-Color="rgba(0, 188, 212, 0.9)" data-max-Spot-Color="rgba(0, 188, 212, 0.9)" data-spot-Color="rgba(0, 188, 212, 0.9)"
                                 data-offset="90" data-width="100%" data-height="100px" data-line-Width="1" data-line-Color="rgba(0, 188, 212, 0)"
                                 data-fill-Color="rgba(0, 188, 212, 0.3)"> 6,4,7,6,9,3,3,5,7,4,2,3,7,6 </div>
                    </div>
                </div>
            </div>
        </div>      
