...
<section class="content home">
	...
	if ($_POST["nombre"] != "" && $_POST["apellidos"]){
		...
		$sql = "INSERT INTO doctores (`idDoctor`, `Nombres`, `Apellidos`, `fechaNacimiento`, `direccion`, `telefono`, `ciudad`, `sexo`, `imagen`)
		VALUES (NULL, '$nombre', '$apellidos', '$ano-$mes-$dia', '$direccion', '$celular', '$ciudad', '$sexo', '$imgContenido')";
		...
		echo "<a href='doctores.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    ...
                    echo"<div class='content'>";
                        echo"<div class='text'>Doctor añadido correctamente!</div>";
                        echo"<div class='number'> Todo Ok |  Ver todos los doctores</div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
		...
		echo "<a href='agregar-doctor.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    ...
                    echo"<div class='content'>";
                        ...
                        echo"<div class='number'> A&ntilde;adir otro doctor </div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
	}
