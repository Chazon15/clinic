...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>CALENDARIO</h2>
            <big class="text-muted">¿Cómo añadir una cita en el calendario?</big> <br />
			<small>
				<ul>
				<li>Clic en el botón + Google Calendar</li>								
				<li>Se abrira una ventana de google, añadirlo alli, una vez realizado, cerrar ventana y actualizar el programa con f5.</li>
				</ul>
			</small>
        </div>
...
<iframe src="https://calendar.google.com/calendar/embed?src=chazonceleste%40gmail.com&ctz=America%2FLima" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe> 
       <!-- PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP-->
	</div>
</section>
