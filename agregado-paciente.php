...
<section class="content home">
	...
	if ($_POST["nombre"] != "" && $_POST["apellidos"]){
		...
		$sql = "INSERT INTO pacientes (`idPaciente`, `Nombres`, `fechanacimiento`, `telefono`, `direccion`, `alergias`, `comonosconocio`, `Apellidos`, `sexo`, `motivoconsulta`)
		VALUES (NULL, '$nombre', '$ano-$mes-$dia', '$celular', '$direccion', '$alergia', '$conocio', '$apellidos', '$sexo', '$motivo')";
		...
		echo "<a href='pacientes.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    ...
                    echo"<div class='content'>";
                        echo"<div class='text'>Paciente añadido correctamente!</div>";
                        echo"<div class='number'> Todo Ok |  Ver todos los pacientes </div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
		...
		echo "<a href='agregar-paciente.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    ...
                    echo"<div class='content'>";
                        ...
                        echo"<div class='number'> A&ntilde;adir otro paciente </div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
	}
