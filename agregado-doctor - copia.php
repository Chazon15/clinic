            ...
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-balance-wallet"></i><span>Pagos</span> </a>
                    <ul class="ml-menu">
                        ...
                        <li> <a href="#">Añadir un pago</a></li>
                        <li> <a href="#">A deuda</a></li>
                    </ul>
                </li>               
            </ul>
        </div>
...
<section class="content home">
	...
	if ($_POST["idDoctor"] != "" ){
		...
		$sql = "INSERT INTO fichas (`idFicha`,`idDoctor`, `idPaciente`, `Haber`, `fecha`)
		VALUES (NULL, '$idDoctor', '$idPaciente', '$haber', '$ano-$mes-$dia')";
