						...
						echo"<div class='body'>";
							echo"<div class='row'>";
								...
								echo"<div class='col-md-8 col-sm-8 m-b-0'>";
									...
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>FICHA Nº</label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='idFicha' value='".$fila['idFicha']."'>";										
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";																								
										echo"<label style='font-weight: 800;color: black;width: 25%;'>DOCTOR </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='Apellidos' value='".$nomDoctor." ".$apellDoctor."'>";										
									echo"</h5>";							
																		
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>PACIENTE </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='direccion' value='".$nomPaciente." ".$apellPaciente."'>";										
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>DEBE </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='telefono' value='".$fila['Debe']."'>";						
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>HABER </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='telefono' value='".$fila['Haber']."'>";						
									echo"</h5>";	
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>SALDO </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='telefono' value='".$fila['Saldo']."'>";						
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>MONEDA </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='telefono' value='".$moneda."'>";						
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>FECHA </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='ciudad' value='".$dia."/".$mes."/".$ano."'>";						
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>TRAT. </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='ciudad' value='".$nomTratamiento."'>";						
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black;width: 25%;'>OBS. </label>
											<input style='border: none; background: transparent; width:70%;' type='text' name='ciudad' value='".$fila['observacion']."'>";						
									echo"</h5>";
