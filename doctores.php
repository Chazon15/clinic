...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DOCTORES</h2>
            <big class="text-muted">Clínica Odontológica IBERICO</big> <br />			
        </div>
...
<!-- PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP-->
						...
						echo"<div class='body'>";
							echo"<div class='row'>";
								...
								echo"<div class='col-md-4 col-sm-4 text-center m-b-0'>";
									...
									//if ( $fila['imagen'] != ""){										
									//	echo"<img src='fotosDoctores.php?id=$idDoctor' alt='Img blob desde MySQL' width='120px' height='120px' />";
									//}									
									
										if ($fila['sexo'] == 20 or $fila['sexo'] == "femenino" ){
											echo"<a href='#' class='p-profile-pix'><img src='assets/images/random-avatar6.jpg' alt='user' class='img-thumbnail img-fluid'></a>";
										}
										else{
											echo"<a href='#' class='p-profile-pix'><img src='assets/images/random-avatar4.jpg' alt='user' class='img-thumbnail img-fluid'></a>";
										}
										
								echo"</div>";
								
								echo"<div class='col-md-8 col-sm-8 m-b-0'>";
									echo"<form action='modificar-doctor.php' method='post' id='f3' name='fmoddoctor' class='formulario'>";/*FORMULARIO EDICION DOCTORES*/									
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black; width: 20%;'>NOM. </label>
											<input style='border: none; background: transparent;' width: 75%; type='text' name='Nombres' value='".$fila['Nombres']."'>";										
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black; width: 20%;'>APELL </label>
											<input style='border: none; background: transparent;' width: 75%; type='text' name='Apellidos' value='".$fila['Apellidos']."'>";										
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black; width: 20%;'>EDAD </label>
											<input style='border: none; background: transparent;' width: 75%; type='text' name='fecha' value='".$dia."/".$mes."/".$ano."'>";										
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black; width: 20%;'>DIR. </label>
											<input style='border: none; background: transparent;' width: 75%; type='text' name='direccion' value='".$fila['direccion']."'>";										
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black; width: 20%;'>CEL. </label>
											<input style='border: none; background: transparent;' width: 75%; type='text' name='telefono' value='".$fila['telefono']."'>";						
									echo"</h5>";	
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black; width: 20%;'>CIUD </label>
											<input style='border: none; background: transparent;' width: 75%; type='text' name='ciudad' value='".$fila['ciudad']."'>";						
									echo"</h5>";
									
									echo"<h5 class='m-b-0'>";										
										echo"<label style='font-weight: 800;color: black; width: 20%;'>SEXO </label>
											<input style='border: none; background: transparent;' width: 75%; type='text' name='sexo' value='".$sexoLetra."'>";						
									echo"</h5>";
									
									echo"<input type='hidden' name='idDoctor' value='".$fila['idDoctor']."'>";									
									
									/*echo"<a href='hola' onclick=alerta(); class='btn btn-raised text-white bg-danger'>BORRAR</a>";*/
									//echo"<button name='elimina' onclick='eliminar(this)' type='button' class='elimina btn btn-raised text-white bg-danger' value='".$fila['idDoctor']."'>BORRAR</button>";
		...
		function eliminar(e){
			...
			$.ajax({
				type: 'POST',
				url: 'borrar-doctor.php',
				data: 'id='+e.value,
				success: function(respuesta) {					
					alert("Se borro el doctor");					
					location.reload();
			   }
			});	
		}
