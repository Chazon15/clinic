...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>FICHAS</h2>
            <big class="text-muted">¿Cómo añadir fichas?</big> <br />
			<small>
				<ul>
				<li>Buscar el paciente, si no está en la base de datos entonces añadirlo</li>				
				<li>Una vez ubicado el paciente, darle clic al botón + FICHA</li>
				<li>Te llevara a otra pestaña donde tendrás que elegir el doctor, el tratamiento, etc.</li>
				</ul>
			</small>
        </div>
...
<!-- PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP-->
		...
		En primer lugar, busca por apellido el  paciente, si aún no están sus datos, añadirlos <a href='agregar-paciente.php' class='btn  btn-raised bg-cyan'>aquí</a>
