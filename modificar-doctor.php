...
<section class="content home">
	...
	if ($_POST["idDoctor"] != ""){
		...
		$sql = "UPDATE doctores SET sexo='".$sexo."', fechanacimiento='".$ano."-".$mes."-".$dia."', Nombres='".$Nombres."',Apellidos='".$Apellidos."',direccion='".$direccion."',telefono='".$telefono."',ciudad='".$ciudad."' WHERE idDoctor=".$idDoctor."";

			$resultado=mysqli_query($mysqli,$sql) or die ('Error en el query database');
			
		
		
		echo "<a href='doctores.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    echo"<div class='icon'> <i class='zmdi zmdi-check-square col-green'></i> </div>";
                    echo"<div class='content'>";
                        echo"<div class='text'>Doctor actualizado correctamente!</div>";
                        echo"<div class='number'> Se modificó, todo Ok </div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
		
		echo "<a href='agregar-doctor.php'><div class='col-lg-6 col-md-6 col-sm-6'>";
                echo"<div class='info-box-4 hover-zoom-effect'>";
                    echo"<div class='icon'> <i class='zmdi zmdi-accounts-add col-blue'></i> </div>";
                    echo"<div class='content'>";
                        echo"<div class='text'>Clínica Odontológica Iberico</div>";
                        echo"<div class='number'> Añadir otro doctor </div>";
                    echo"</div>";
                echo"</div>";
        echo"</div></a><br />";
